...
* **WW4 identification:** Identify the code as WW4 code in comments at the top of the file, using approach as already established in the **develop** branch of the main WW4 repository
...
* **Code heritage:** If an initial code is converted from Matlab to Python or C++, identify the original Matlab code and its original and contributing authors in the documentation.
